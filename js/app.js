...
var divElem = document.getElementById("more");
divElem.innerHTML = bacon;
}
...
function lessContent(){
	var hideContents = document.getElementById("less");
...
document.addEventListener("click",showHideButton,)